...
If unlocked, user can directly claim.
If locked, system checks verification status.
Upon successful claim, deal is added to the user dashboard.
Backend updates claim status (Pending → Approved).
Frontend shows feedback animation to confirm claim action.
